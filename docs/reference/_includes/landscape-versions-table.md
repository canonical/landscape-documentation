| Version | Released | Standard support until | ESM until | Installs on Ubuntu |
|---------|----------|------------------------|-----------|---------------------|
| {ref}`reference-release-notes-26-04-lts` | 2026-Apr | 2031-Apr | 2038-Apr | 22.04 LTS or 24.04 LTS |
