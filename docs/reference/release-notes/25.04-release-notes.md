...
myst:
  html_meta:
    description: "Release notes for Landscape version 25.04 (April 2025). Introduces security profiles with CIS/DISA-STIG compliance, script profiles, reboot profiles, and client sanitization."
---
...
* API requests no longer stall on some malformed paths
