...
Use the {ref}`how-to-quickstart-installation` or {ref}`how-to-manual-installation` installation guides, with the following changes:
...
If you're {ref}`how-to-configure-postfix`, add the following change:
