...
At this point, visiting `https://$FQDN` shows the **Welcome to Landscape** sign-up form for Landscape’s first Global Administrator account. After you create that account and sign in:
