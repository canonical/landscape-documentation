...
- **Description**: A description for the profile which summarizes the configurations in the profile's associated cloud-init.yaml file. For example, "Install NodeJS and NPM"
