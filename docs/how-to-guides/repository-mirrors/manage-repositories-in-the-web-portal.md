...
```{note}
This document applies to **Landscape 25.10 and earlier**. If you're using Landscape 26.04 LTS or later, see {ref}`managing repositories (26.04 LTS and later)<how-to-manage-repos-web-portal-2604>` instead.
