...
```{note}
This document applies to **Landscape 25.10 and earlier**. <!-- TODO: See the {ref}`reference-release-notes-26-04-lts` for details on our changes to repository management in 26.04. -->
