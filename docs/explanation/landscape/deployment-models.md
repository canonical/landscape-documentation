...
Optional services such as [Deb Archive](/explanation/landscape/landscape-server-architecture#deb-archive) are installed on the same machine as the Landscape Server.
...
In Juju deployments, the [Deb Archive](/explanation/landscape/landscape-server-architecture#deb-archive) service is deployed as a charm in the same model as the Landscape Server charm.
